            ...
            <form method="POST" className="w-full" onSubmit={handleProfileForm}>
              <div className="w-full mb-4  relative">
                <figure className="w-full">
                  <img
                    className="h-[272px] w-full  rounded-2xl object-cover shadow-item-shadow"
                    src={
                      uploadImage ? uploadImage : "./assets/images/mount.jpg"
                    }
              ...
              {/* input fields */}
              <div className="flex flex-col mt-[72px] font-robot">
